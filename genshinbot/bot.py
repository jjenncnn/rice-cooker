...
@bot.command()
async def menu(ctx):
    embeded = discord.Embed(title="Menu", description=bulk.menus['menu'])
    await ctx.send(embed=embeded)

@bot.command()
async def characters(ctx, *, arg=None):
    if arg==None:
        r = requests.get('https://genshin.jmp.blue/characters').text
        res = json.loads(r)
        char_list = ""

        embeded = discord.Embed(title="Characters", description=bulk.menus['charcters'])

        for i in res:
            char_list += "\- {}\n".format(i)

        embeded.add_field(name="Character List", value=char_list, inline=False)
        await ctx.send(embed=embeded)
...
@bot.command()
async def skills(ctx, *, arg=None):
    if arg==None:
        r = requests.get('https://genshin.jmp.blue/characters').text
        res = json.loads(r)
        char_list = ""

        embeded = discord.Embed(title="Characters", description=bulk.menus['skills'])
...
async def cons(ctx, *, arg=None):
    if arg==None:
        ...
        embeded = discord.Embed(title="Character Constellations", description=bulk.menus['constellation'])
...
@bot.command()
async def weapons(ctx, *, arg=None):
    if arg==None:
        r = requests.get('https://genshin.jmp.blue/weapons/').text
        res = json.loads(r)

        embeded = discord.Embed(title="Weapons", description=bulk.menus['weapons'])
...
@bot.command()
async def artifacts(ctx, *, arg=None):
    if arg==None:
        r = requests.get("https://genshin.jmp.blue/artifacts").text
        res = json.loads(r)
        ar_list = ""

        embeded = discord.Embed(title="Artifacts", description=bulk.menus['artifacts'])

        for i in res:
            ar_list += "\- {}\n".format(i)
        
        embeded.add_field(name="Artifacts List", value=ar_list, inline=False)
        await ctx.send(embed=embeded)
...
@bot.command()
async def nations(ctx, *, arg=None):
    if arg==None:
        r = requests.get("https://genshin.jmp.blue/nations").text
        res = json.loads(r)
        nation_list = ""

        embeded = discord.Embed(title="Nations", description=bulk.menus['nations'])

        for i in res:
            nation_list += "\- {}\n".format(string.capwords(i))
        
        embeded.add_field(name="Nation List", value=nation_list, inline=False)
...
async def materials(ctx):
    embeded = discord.Embed(title="Materials", description=bulk.menus['materials'])
    await ctx.send(embed=embeded)

@bot.command()
async def elements(ctx, *, arg=None):
    if arg==None:
        r = requests.get("https://genshin.jmp.blue/elements").text
        res = json.loads(r)
        ele_list = ""

        embeded = discord.Embed(title="Elements", description=bulk.menus['elements'])

        for i in res:
            ele_list += "\- {}\n".format(string.capwords(i))
        
        embeded.add_field(name="Element List", value=ele_list, inline=False)
...
@bot.command()
async def boss(ctx, *, arg=None):
    if arg==None:
        boss_list = "\- Azhdaha\n\- Childe\n\- La Signora\n\- Lupus Boreas\n\- Magatsu Mitake Narukami No Mikoto\n\- Stormterror"

        embeded = discord.Embed(title="Weekly Bosses", description=bulk.menus['boss'])
        embeded.add_field(name="Weekly Bosses List", value=boss_list, inline=False)
        await ctx.send(embed=embeded)
...
@bot.command()
async def enemy(ctx, *, arg=None):
    if arg==None:
        r = requests.get("https://genshin.jmp.blue/enemies").text
        res = json.loads(r)
        en_list = ""

        embeded = discord.Embed(title="Enemies", description=bulk.menus['enemies'])
        
        for i in res:
            en_list += "\- {}\n".format(i)

        embeded.add_field(name="Enemy Class List", value=en_list, inline=False)
        await ctx.send(embed=embeded)
        ...
        if "elemental-description" in res:
            for i in res['elemental-description']:
                embeded.add_field(name="Variation: {}".format(i['element']), value=i["description"], inline=False)
...
@bot.command()
async def food(ctx, *, arg=None):
    if arg==None:
        r = requests.get(links.food).text
        res = json.loads(r)

        embeded = discord.Embed(title="Food", description=bulk.menus['food'])
...
@bot.command()
async def potion(ctx, *, arg=None):
    if arg==None:
        r = requests.get(links.potion).text
        res = json.loads(r)
        potions = ""
        
        embeded = discord.Embed(title="Potions", description=bulk.menus['potions'])
        
        for i in res:
            potions += "\- {}\n".format(res[i]['name'])
        
        embeded.add_field(name="Potion List", value=potions, inline=False)
...
@bot.command()
async def bm(ctx, *, arg=None):
    if arg==None:
        r = requests.get(links.materials.format('boss-material')).text
        res = json.loads(r)
        bm_list = ""

        embeded = discord.Embed(title="Boss Materials", description=bulk.menus['boss-material'])

        for i in res:
            bm_list += "\- {}\n".format(res[i]['name'])
        
        embeded.add_field(name="Boss Materials List", value=bm_list, inline=False)
...
@bot.command()
async def ca(ctx, arg1=None, arg2=None):
    if arg1==None and arg2==None:
        ...
        embeded = discord.Embed(title="Character Ascension Stones", description=bulk.menus['character-ascension'])
        ...
        embeded.add_field(name="Cryo Stones", value=cryo, inline=False)
        embeded.add_field(name="Pyro Stones", value=pyro, inline=False)
        embeded.add_field(name="Hydro Stones", value=hydro, inline=False)
        embeded.add_field(name="Electro Stones", value=electro, inline=False)
        embeded.add_field(name="Anemo Stones", value=anemo, inline=False)
        embeded.add_field(name="Geo Stones", value=geo, inline=False)
        embeded.add_field(name="Dendro Stones", value=dendro, inline=False)
        embeded.add_field(name="Brilliant Stones", value=traveler, inline=False)
...
@bot.command()
async def ce(ctx, *, arg=None):
    if arg==None:
        r = requests.get(links.materials.format("character-experience")).text
        res = json.loads(r)
        item_list = ""

        embeded = discord.Embed(title="Character Experience Materials", description=bulk.menus['character-experience'])

        for i in res['items']:
            item_list += "\- {}\n".format(i['name'])
        
        embeded.add_field(name="Character EXP Materials List", value=item_list, inline=False)
        await ctx.send(embed=embeded)
...
@bot.command()
async def ci(ctx, *, arg=None):
    if arg==None:
        r = requests.get(links.materials.format("cooking-ingredients")).text
        res = json.loads(r)
        ci_list = ""

        embeded = discord.Embed(title="Cooking Ingredients", description=bulk.menus['cooking-ingredients'])

        for i in res:
            ci_list += "\- {}\n".format(res[i]['name'])
        
        embeded.add_field(name="Cooking Ingredients List", value=ci_list, inline=False)
...
@bot.command()
async def coa(ctx, arg1=None, arg2=None):
    if arg1==None and arg2==None:
        r = requests.get(links.materials.format("common-ascension")).text
        res = json.loads(r)

        embeded = discord.Embed(title="Common Ascension Materials", description=bulk.menus['common-ascension'])

        for i in res:
            f1 = i.replace("-", " ")
            item_list = ""
            for j in res[i]['items']:
                item_list += "\- {}\n".format(j['name'])
            embeded.add_field(name="{}".format(string.capwords(f1)), value=item_list, inline=False)
...
@bot.command()
async def ls(ctx, arg1=None, arg2=None):
    if arg1 == None and arg2 == None:
        r = requests.get(links.materials.format("local-specialties")).text
        res = json.loads(r)

        embeded = discord.Embed(title="Local Specialties", description=bulk.menus['local-specialties'])
        
        for i in res:
            f1 = string.capwords(i)
            item_list = ""
            for j in res[i]:
                item_list += "\- {}\n".format(j['name'])
            embeded.add_field(name=f1, value=item_list, inline=False)
...
@bot.command()
async def tb(ctx, arg1=None, arg2=None):
    if arg1 == None and arg2 == None:
        r = requests.get(links.materials.format("talent-book")).text
        res = json.loads(r)

        embeded = discord.Embed(title="Talent Books", description=bulk.menus['talent-book'])
        ...
        for i in res:
            ...
            for j in res[i]['items']:
                item_list += "\- {}\n".format(j['name'])
            embeded.add_field(name=a, value=item_list, inline=False)
...
@bot.command()
async def tbs(ctx, *, arg=None):
    if arg==None:
        r = requests.get(links.materials.format("talent-boss")).text
        res = json.loads(r)
        item_list = ""

        embeded = discord.Embed(title="Talent Boss Materials", description=bulk.menus['talent-boss'])

        for i in res:
            item_list += "\- {}\n".format(res[i]['name'])

        embeded.add_field(name="Talent Boss Materials List", value=item_list, inline=False)
...
@bot.command()
async def wa(ctx, arg1=None, arg2=None):
    if arg1==None and arg2==None:
        r = requests.get(links.materials.format("weapon-ascension")).text
        res = json.loads(r)
        
        embeded = discord.Embed(title="Weapon Ascension Materials", description=bulk.menus['weapon-ascension'])
        ...
        for i in res:
            ...
            for j in res[i]['items']:
                item_list += "\- {}\n".format(j['name'])
            embeded.add_field(name=string.capwords(f1), value=item_list, inline=False)
...
@bot.command()
async def we(ctx, *, arg=None):
    if arg==None:
        r = requests.get(links.materials.format("weapon-experience")).text
        res = json.loads(r)
        item_list = ""

        embeded = discord.Embed(title="Weapon Experience Materials", description=bulk.menus['weapon-experience'])

        for i in res['items']:
            item_list += "\- {}\n".format(i['name'])
        
        embeded.add_field(name="Weapon EXP Material List", value=item_list, inline=False)
        await ctx.send(embed=embeded)
...
@bot.command()
async def domain(ctx, arg1=None, arg2=None, arg3=None):
    if arg1==None and arg2==None and arg3==None:
        r = requests.get("https://genshin.jmp.blue/domains").text
        res = json.loads(r)
        domains = ""
        days = "\- mon\n\- tue\n\- wed\n\- thu\n\- fri\n\- sat\n\- sun"
    
        embeded = discord.Embed(title="Domains", description=bulk.menus['domains'])
        
        for i in res:
            domains += "\- {}\n".format(i)
        embeded.add_field(name="Domain List", value=domains, inline=False)
        embeded.add_field(name="Days", value=days, inline=False)
        await ctx.send(embed=embeded)
    else:
        arg1 = arg1.replace(" ", "-").lower()
